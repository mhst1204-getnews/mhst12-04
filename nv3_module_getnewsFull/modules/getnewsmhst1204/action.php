...
$sql_drop_module[]='DROP TABLE IF EXISTS `nv_new_temp`';
...
$sql_create_module[]='CREATE TABLE IF NOT EXISTS `config` (
                      ...
                      `chose` int(3) NOT NULL,
                      PRIMARY KEY  (`action`)
                    ) ENGINE=MyISAM DEFAULT CHARSET=utf8;';

$sql_create_module[]="INSERT INTO `config` (`action`, `chose`) VALUES
                    ('lientuc', 2),('binhthuong', 7),
                    ('it', 12),('tinlayve', 0);";
...
$sql_create_module[]='CREATE TABLE IF NOT EXISTS `article_path` (
                      ...
                      `articleleftpath` varchar(100) NOT NULL,
                      `articlerightpath` varchar(100) NOT NULL,
                      PRIMARY KEY  (`id`)
                    ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;';
?>