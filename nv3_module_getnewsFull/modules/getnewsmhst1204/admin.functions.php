...
$submenu['cat']=$lang_module['qtcm'];
$submenu['add_cat']=$lang_module['taonhomcm'];
$submenu['config'] = $lang_module['config'];
//$submenu['test'] = $lang_module['test'];
$allow_func = array( 'main','keywords','savenewsauto','sourceajax','changestatus','auto','topicajax','saveconfignktt','cat','add_cat','article','publtime','exptime','nklaytintudong','del_chuyenmuc','config','getcontent','saveconfig','getarea','add_news','rss','getxml','savenews','test','alias','del_content','saveconfigauto','saveconfigcm');
